...
class BuildUpdater:
    def __init__(
        ...
        self.windows_data_path = self.base_dir / self.config["data_path"]
    ...
    def modify_sdk_url(self, sdkurl: str):
        ...
        if self.is_windows:
            ...
            try:
                ...
                raise RuntimeError(f"SDKConfigSettings解析失败: {e}") from e
    ...
    def prepare_windows(self):
        ...
        shutil.copy2(
            launcher_resources_path,
            resources_path
        )
        shutil.copy2(
            launcher_resources_res_path,
            resources_res_path
        )
    ...
    def _update_windows_resource_config(self, file_list):
        ...
        resources = {
            "/BlueArchive_Data/resources.assets":
                self.data_path / "resources.assets",
            "/BlueArchive_Data/resources.assets.resS":
                self.data_path / "resources.assets.resS",
        }
